...
void Excersize_2_3(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("따라서 평균 속력의 공식은 : vavg = (xf - xi / tf - ti)입니다 \n\n");
		printf("나중거리 xf는 %6.2lfkm이고, 처음거리 vi는 %6.2lfkm입니다. \n", distance, distance_0);
		printf("나중시간 tf는 %6.2lf h %6.2lf m이고, 처음시간 ti는 %6.2lf h입니다.\n", time_h, time_m, time_0);
	...
	if (answer == SHOW)
	{
		...
		printf("따라서 %6.2lf x 1000 / %6.2lf = %6.2lf이므로\n답은 %6.2lf 입니다\n", distance, time_f, velocity, velocity);
